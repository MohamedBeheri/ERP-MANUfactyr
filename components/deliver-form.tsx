        ...
        <>
          ...
          {payMethod === 'نقدي جزئي' && (
            <div>
              ...
              <input type="number" min="0" max={netAmount} step="0.01" value={paidAmount} onChange={(e) => setPaidAmount(e.target.value)} placeholder="المبلغ المدفوع" className={inputCls} />
            </div>
          )}
