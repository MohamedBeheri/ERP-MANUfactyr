...
import { ShoppingBag, Printer, Image as ImageIcon, Truck, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      <div className="flex items-start justify-between gap-3 flex-wrap">
        ...
        <Link href="/purchases/price-tracking" className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-semibold bg-[#0f3460] text-white hover:bg-[#0a2545] shrink-0">
          <TrendingUp className="w-4 h-4" /> تتبّع أسعار الشراء
        </Link>
      </div>
