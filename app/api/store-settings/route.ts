  ...
  try {
    ...
    const settings = await prisma.storeSettings.update({
      ...
      data: {
        ...
        heroInterval: b.heroInterval !== undefined ? Math.max(2, Math.min(30, Number(b.heroInterval) || 6)) : undefined,
        heroMotion: b.heroMotion ?? undefined,
        cardEnabled: b.cardEnabled !== undefined ? !!b.cardEnabled : undefined,
