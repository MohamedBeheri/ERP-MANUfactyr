...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { name, phone, address, area, governorate, lat, lng, activityType, type, customerType, creditLimit, tierId, salesRouteId, delegateId } = body
    ...
    const customer = await prisma.customer.create({
      data: {
        ...
        tierId: tierId || null,
        salesRouteId: salesRouteId || null,
